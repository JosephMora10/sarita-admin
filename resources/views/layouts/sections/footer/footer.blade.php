    ...
    <div class="{{ $containerFooter }}">
        <div class="footer-container d-flex align-items-center justify-content-center py-4 flex-md-row flex-column">
            <div class="text-body">
                ...
                <a href="https://www.linkedin.com/in/joseph-morales-3570a9225" target="_blank" class="footer-link">Joseph Morales</a>
                with the template of 
                <a href="{{ (!empty(config('variables.creatorUrl')) ? config('variables.creatorUrl') : '') }}" target="_blank" class="footer-link">
